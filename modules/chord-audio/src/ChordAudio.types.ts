...
export interface ChordAudioNativeModule {
  ...
  /**
   * Playback lifecycle timeline + polyphony stats (v1.01 Phase 1). Optional:
   * older binaries predate this API.
   */
  getPlaybackDiagnostics?(): Promise<PlaybackDiagnosticsSnapshot>;
