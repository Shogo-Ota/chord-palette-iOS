...
```text
src/lib/music/__tests__/
  catalog.12keys.test.ts
  catalog.intervals-midi.test.ts
  tension.degree.test.ts
  transpose.invariants.test.ts
src/lib/groove/__tests__/
  pianoPatterns.test.ts
  drumPatterns.test.ts
  humanize.deterministic.test.ts
fixtures/
